...
class LEAR(object):
    ...
    def recalibrate(self, Xtrain, Ytrain, time_rec_lambda=0, time_rec_coeff=0):
        ...
        [Ytrain], self.scalerY = scaling([Ytrain], 'Invariant')#Invariant or Std
    ...
    def recalibrate_and_forecast_next_day(self, df, calibration_window, next_day_date, begin_test_date,
        ...
        # use the adapted df_test, where the adapted dataset is plugged in.
...
def evaluate_lear_in_test_dataset(path_datasets_folder=os.path.join('../../../../Epftoolbox_original_code/models', 'datasets'),
                                  path_recalibration_folder=os.path.join('../../../../Epftoolbox_original_code/models',
                                                                         'experimental_files'),
                                  dataset_train='PJM',dataset_test='None', years_test=2, calibration_window=364 * 3,
    ...
    df_train, df_test1 = read_data(dataset=dataset_train, years_test=years_test, path=path_datasets_folder,
                                  begin_test_date=begin_test_date, end_test_date=end_test_date)
    df_train1, df_test = read_data(dataset=dataset_test, years_test=years_test, path=path_datasets_folder,
                                  begin_test_date=begin_test_date, end_test_date=end_test_date)
