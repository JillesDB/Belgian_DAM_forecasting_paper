...
import Evaluate_forecast,Forecasting_P10_P90,Timing_Forecasts
...
def Predict_Evaluate_and_Time(path_real_prices,dataset_train,dataset_test,path_datasets_folder,
    ...
    dict_timing = Forecasting_P10_P90.create_ensemble_forecast(dataset_train=dataset_train,dataset_test=dataset_test,path_real_prices=path_real_prices,path_datasets_folder=path_datasets_folder,
    ...
    print('Results for dataframe train {} with dataframe test from {} until {}, RW {}'.format(dataset_train,dataset_test,begin_test_date, end_test_date,recalibration_window))
    print(Dataframe_evaluation_and_timing)

# Predict_Evaluate_and_Time(path_real_prices=real_prices_path
# ,path_forecasts_folder=forecasts_folder
# ,dataset_train='Full_Dataset',dataset_test='Full_Dataset_P10_Windsolar_P90_Load',path_datasets_folder=datasets_path
# ,begin_test_date='2020-01-01', end_test_date='2022-12-30',recalibration_window=1,calibration_window_set={56,84,112,714,721,728},
# regular=1,weighed=1)
#
# df = pd.read_csv(r'C:\Users\jdeblauw\Documents\GitHub\Belgian_DAM_forecasting_paper\Cleaned_code\P10_P90_folder\P10_P90_datasets\Full_Dataset_P10_Windsolar_P90_Load.csv')
# df = df.set_index('Date')
# df = df.drop(columns=['Unnamed: 0'])
# df = df.fillna(method='ffill')
# print(df)
# df.to_csv(r'C:\Users\jdeblauw\Documents\GitHub\Belgian_DAM_forecasting_paper\Cleaned_code\P10_P90_folder\P10_P90_datasets\Full_Dataset_P10_Windsolar_P90_Load.csv')
# df = pd.read_csv(r'C:\Users\jdeblauw\Documents\GitHub\Belgian_DAM_forecasting_paper\Cleaned_code\P10_P90_folder\P10_P90_datasets\Full_Dataset_P10_Windsolar_Reg_Load.csv')
# df = df.set_index('Date')
# df = df.drop(columns=['Unnamed: 0'])
# print(df)
# df.to_csv(r'C:\Users\jdeblauw\Documents\GitHub\Belgian_DAM_forecasting_paper\Cleaned_code\P10_P90_folder\P10_P90_datasets\Full_Dataset_P10_Windsolar_Reg_Load.csv')
# df = pd.read_csv(r'C:\Users\jdeblauw\Documents\GitHub\Belgian_DAM_forecasting_paper\Cleaned_code\P10_P90_folder\P10_P90_datasets\Full_Dataset_P90_Windsolar_Reg_Load.csv')
# df = df.set_index('Date')
# df = df.drop(columns=['Unnamed: 0'])
# print(df)
# df.to_csv(r'C:\Users\jdeblauw\Documents\GitHub\Belgian_DAM_forecasting_paper\Cleaned_code\P10_P90_folder\P10_P90_datasets\Full_Dataset_P90_Windsolar_Reg_Load.csv')
# df = pd.read_csv(r'C:\Users\jdeblauw\Documents\GitHub\Belgian_DAM_forecasting_paper\Cleaned_code\P10_P90_folder\P10_P90_datasets\Full_Dataset_P90_Windsolar_P10_Load.csv')
# df = df.set_index('Date')
# df = df.drop(columns=['Unnamed: 0'])
# print(df)
# df.to_csv(r'C:\Users\jdeblauw\Documents\GitHub\Belgian_DAM_forecasting_paper\Cleaned_code\P10_P90_folder\P10_P90_datasets\Full_Dataset_P90_Windsolar_P10_Load.csv')
