...
def generate_effect_bar_chart(name_dataframe, path_real_prices, day_to_plot,calibration_window,file_path=None):
    """
...
def create_effect_bar_chart(name_dataframe, path_real_prices, day_to_plot, calibration_window, file_path=None):
