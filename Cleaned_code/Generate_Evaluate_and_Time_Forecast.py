...
# df = pd.read_csv(r'C:\Users\jdeblauw\Documents\GitHub\Belgian_DAM_forecasting_paper\Cleaned_code\Datasets\Dataframes_several_vars\Model5Vars#2_dataframe.csv')
# df = df.set_index('Date')
# df = df.drop(columns=['Unnamed: 0'])
# df.to_csv(r'C:\Users\jdeblauw\Documents\GitHub\Belgian_DAM_forecasting_paper\Cleaned_code\Datasets\Dataframes_several_vars\Model5Vars#2_dataframe.csv')
# df = pd.read_csv(r'C:\Users\jdeblauw\Documents\GitHub\Belgian_DAM_forecasting_paper\Cleaned_code\Datasets\Dataframes_several_vars\Model8Vars#2_dataframe.csv')
# df = df.set_index('Date')
# df = df.drop(columns=['Unnamed: 0'])
# df.to_csv(r'C:\Users\jdeblauw\Documents\GitHub\Belgian_DAM_forecasting_paper\Cleaned_code\Datasets\Dataframes_several_vars\Model8Vars#2_dataframe.csv')
# df = pd.read_csv(r'C:\Users\jdeblauw\Documents\GitHub\Belgian_DAM_forecasting_paper\Cleaned_code\Datasets\Dataframes_several_vars\Model10Vars#2_dataframe.csv')
# df = df.set_index('Date')
# df = df.drop(columns=['Unnamed: 0'])
