...
forecasts_folder = os.path.join(cleaned_code_path, 'Folder_Parallel_Run_1')
...
# ,path_forecasts_folder=forecasts_folder
# ,name_dataframe='Full_Dataset',path_datasets_folder=datasets_path
# ,begin_test_date='2020-01-01', end_test_date='2020-01-07',recalibration_window=1,calibration_window_set={56,84,112,714,721,728},
# regular=1,weighed=1)
# Generate_Evaluate_and_Time_Forecast.Predict_Evaluate_and_Time(path_real_prices=real_prices_path
# ,path_forecasts_folder=forecasts_folder
# ,name_dataframe='Full_Dataset',path_datasets_folder=datasets_path
# ,begin_test_date='2020-01-01', end_test_date='2020-01-06',recalibration_window=7,calibration_window_set={56,84,112,714,721,728},
# regular=1,weighed=1)
# Generate_Evaluate_and_Time_Forecast.Predict_Evaluate_and_Time(path_real_prices=real_prices_path
# ,path_forecasts_folder=forecasts_folder
# ,name_dataframe='Full_Dataset',path_datasets_folder=datasets_path
# ,begin_test_date='2020-01-01', end_test_date='2020-01-06',recalibration_window=28,calibration_window_set={56,84,112,714,721,728},
# regular=1,weighed=1)
# Generate_Evaluate_and_Time_Forecast.Predict_Evaluate_and_Time(path_real_prices=real_prices_path
# ,path_forecasts_folder=forecasts_folder
# ,name_dataframe='Full_Dataset',path_datasets_folder=datasets_path
# ,begin_test_date='2020-01-01', end_test_date='2020-01-06',recalibration_window=84,calibration_window_set={56,84,112,714,721,728},
# regular=1,weighed=1)
# Generate_Evaluate_and_Time_Forecast.Predict_Evaluate_and_Time(path_real_prices=real_prices_path
# ,path_forecasts_folder=forecasts_folder
# ,name_dataframe='Full_Dataset',path_datasets_folder=datasets_path
# ,begin_test_date='2020-01-01', end_test_date='2020-01-06',recalibration_window=168,calibration_window_set={56,84,112,714,721,728},
# regular=1,weighed=1)
# Generate_Evaluate_and_Time_Forecast.Predict_Evaluate_and_Time(path_real_prices=real_prices_path
# ,path_forecasts_folder=forecasts_folder
# ,name_dataframe='Full_Dataset',path_datasets_folder=datasets_path
# ,begin_test_date='2020-01-01', end_test_date='2020-01-06',recalibration_window=1093,calibration_window_set={56,84,112,714,721,728},
# regular=1,weighed=1)
#
#
#
...
# ,begin_test_date='2020-01-01', end_test_date='2020-01-06',recalibration_window=1,calibration_window_set={56,84,112,714,721,728},
# regular=1,weighed=1)
# Generate_Evaluate_and_Time_Forecast.Predict_Evaluate_and_Time(path_real_prices=real_prices_path
# ,path_forecasts_folder=forecasts_folder
